        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('biodata')}}">Lihat Data</a></li>
        ...
        <div class="card-body">
            ...
            {{csrf_field()}}
              <div class="form-group">
                ...
                <input type="text" id="namamhs" name="namamhs" class="form-control" placeholder="Nama Mahasiwa">
              </div>
              <div class="form-group">
                <label>NPM</label>
                <input type="text" id="npm" name="npm" class="form-control" placeholder="NPM">
              </div>
              <div class="form-group">
